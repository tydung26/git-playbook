...
## 1. Pick and Prepare Task

1. Pick a task from the backlog
2. Assign it to yourself
3. Switch the task state to **In Progress**
...
- Useful context for code review
- How to reproduce if there is a problem or bug
...
- Pipeline is green
- Code is approved
- The assignee or reviewer will **merge to master** (and potentially to older branches if needed)
...
4. Retest thoroughly
5. Switch task state back to **Code Review**
6. Notify reviewer
